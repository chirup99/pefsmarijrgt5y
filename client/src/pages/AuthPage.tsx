...
import { Infinity as InfinityIcon, Eye, EyeOff, QrCode, ArrowRight, Loader2, Globe } from "lucide-react";
              ...
              {mode === "login" ? (
                <div className="flex flex-col items-center text-center space-y-6 py-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <h3 className="text-2xl font-bold text-white tracking-tight">Ram</h3>
                    <p className="text-white/40 text-sm">Product Designer & Developer</p>
                  </div>

                  {/* Social/Business Links Row */}
                  <div className="flex items-center justify-center gap-4 w-full pt-2">
                    <button type="button" className="p-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-white/70 hover:text-white transition-all duration-200 group">
                      <SiLinkedin className="w-5 h-5" />
                    </button>
                    <button type="button" className="p-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-white/70 hover:text-white transition-all duration-200">
          ...
          <div className="pt-2">
            ...
            >
              {isPending ? (
                ...
                <>
                  {mode === "login" ? "Check personal portal" : "Scan to Create"} 
